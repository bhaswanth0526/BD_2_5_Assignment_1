...
app.get("/products/filter/ram", (req, res)=>{
  res.json(filterByRam(products, req.query.ram));
});
...
app.get("/products/filter/rom", (req, res)=>{
  res.json(filterByRom(products, req.query.rom));
});
...
app.get("/products/filter/os", (req, res)=>{
  res.json(filterByOs(products, req.query.os));
});
...
app.get("/products/filter/price", (req, res)=>{
  res.json(filterByPrice(products, req.query.price));
});
